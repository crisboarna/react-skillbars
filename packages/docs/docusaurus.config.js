...
const config = {
  ...
  baseUrl: '/react-skillbars/',
  onBrokenLinks: 'throw',
  onBrokenMarkdownLinks: 'warn',
  favicon: 'img/favicon.ico',
  organizationName: 'crisboarna',
  projectName: 'react-skillbars',
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/crisboarna/react-skillbars',
            label: 'GitHub',
            position: 'right',
          },
        ],
            ...
            items: [
              {
                ...
                href: 'https://stackoverflow.com/questions/tagged/react-skillbars',
              },
            ],
          },
          {
