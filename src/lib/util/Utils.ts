export class Utils {
    public static isString = (value: any) => Object.prototype.toString.call(value) === '[object String]';

    public static isNumber = (value: any) => Object.prototype.toString.call(value) === '[object Number]';
    ...
    public static getHeight = (propHeight : number | string) => Utils.isString(propHeight) ? propHeight : `${propHeight}px`;
}